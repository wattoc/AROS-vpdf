...
struct MUIP_VPDFWindow_OpenFile{IPTR MethodID; char *filename; int mode;};
struct MUIP_VPDFWindow_SaveFile{IPTR MethodID; char *filename; int mode;};
struct MUIP_VPDFWindow_CreateTab{IPTR MethodID;};
struct MUIP_VPDFWindow_CloseTab{IPTR MethodID;};
struct MUIP_VPDFWindow_UpdateActive{IPTR MethodID; int active;};
struct MUIP_VPDFWindow_DetachView{IPTR MethodID; int tabind; Object *docview; Object *title;};
struct MUIP_VPDFWindow_AttachView{IPTR MethodID; int tabind; Object *docview; Object *title;};
